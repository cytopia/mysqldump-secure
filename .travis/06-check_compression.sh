...
echo "##########################################################################################"
echo "#"
echo "#  6.  C H E C K I N G   C O M P R E S S I O N"
echo "#"
echo "##########################################################################################"
...
echo "--------------------------------------------------------------------------------"
echo "-"
echo "-  6.2 \$COMPRESS_BIN"
echo "-"
echo "--------------------------------------------------------------------------------"

echo
echo "----------------------------------------"
echo " 6.2.1 #COMPRESS_BIN=\"gzip\""
echo "----------------------------------------"
...
echo "--------------------------------------------------------------------------------"
echo "-"
echo "-  6.3 \$COMPRESS_ARG"
echo "-"
echo "--------------------------------------------------------------------------------"

echo
echo "----------------------------------------"
echo " 6.3.1 #COMPRESS_ARG=\"-9 --stdout\""
echo "----------------------------------------"
...
echo "--------------------------------------------------------------------------------"
echo "-"
echo "-  6.4 \$COMPRESS_EXT"
echo "-"
echo "--------------------------------------------------------------------------------"

echo
echo "----------------------------------------"
echo " 6.4.1 #COMPRESS_EXT=\"gz\""
echo "----------------------------------------"
